...
n(mg,G);mg.prototype.m=function(){for(;this.b.length;){var a=this.b.pop();a.target.removeEventListener(a.name,a.hb)}G.prototype.m.call(this)};var ng=/cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;function og(a){a=a||"";if(window.spf){var b=a.match(ng);spf.style.load(a,b?b[1]:"",void 0)}else pg(a)}
...
;function ah(a,b){G.call(this);this.l=this.T=a;this.H=b;this.o=!1;this.f={};this.R=this.G=null;this.w=new I;tc(this,y(uc,this.w));this.i={};this.O=this.S=this.g=this.Y=this.b=null;this.N=!1;this.j=this.D=null;this.U={};this.ua=["onReady"];this.X=null;this.ka=NaN;this.P={};bh(this);this.V("WATCH_LATER_VIDEO_ADDED",this.Ma.bind(this));this.V("WATCH_LATER_VIDEO_REMOVED",this.Na.bind(this));this.V("onAdAnnounce",this.ya.bind(this));this.va=new mg(this);tc(this,y(uc,this.va))}
...
function bh(a){a.o=!1;if(a.R)for(var b in a.i)a.R(b,a.i[b]);for(var c in a.P)ee(parseInt(c,10));a.P={};a.G=null;a.R=null;for(var d in a.f)a.f[d]=null;a.f.addEventListener=a.V.bind(a);a.f.removeEventListener=a.Ua.bind(a);a.f.destroy=a.dispose.bind(a);a.f.getLastError=a.Ca.bind(a);a.f.getPlayerType=a.Da.bind(a);a.f.getCurrentVideoConfig=a.Ba.bind(a);a.f.loadNewVideoConfig=a.ha.bind(a);a.f.isReady=a.La.bind(a)}
...
k.Ua=function(a,b){if(!this.h){var c=ch(this,b);c&&ld(this.w,a,c)}};
...
k.Wa=function(a,b){this.i&&!this.h&&Ah(this.b,a,this.ba(a,b))};
...
n(Gh,Fh);function Hh(){var a=this.f=new Gh(!!Q("WIDGET_ID_ENFORCE")),b=x(this.Qa,this);a.i=b;a.j=null;this.f.channel="widget";if(a=Q("WIDGET_ID"))this.f.sessionId=a;this.g=[];this.j=!1;this.i={}}
k=Hh.prototype;k.Qa=function(a,b,c){"addEventListener"==a&&b?(a=b[0],this.i[a]||"onReady"==a||(this.addEventListener(a,Ih(this,a)),this.i[a]=!0)):this.ta(a,b,c)};
k.ta=function(){};
...
k.dispose=function(){this.f=null};function Kh(a){Hh.call(this);this.b=a;this.h=[];this.addEventListener("onReady",x(this.Oa,this));this.addEventListener("onVideoProgress",x(this.ab,this));this.addEventListener("onVolumeChange",x(this.bb,this));this.addEventListener("onApiChange",x(this.Va,this));this.addEventListener("onPlaybackQualityChange",x(this.Xa,this));this.addEventListener("onPlaybackRateChange",x(this.Ya,this));this.addEventListener("onStateChange",x(this.Za,this));this.addEventListener("onWebglSettingsChanged",x(this.cb,
this))}
...
k.Xa=function(a){Jh(this,{playbackQuality:a})};
k.Ya=function(a){Jh(this,{playbackRate:a})};
...
k.bb=function(){Jh(this,{muted:this.b.isMuted(),volume:this.b.getVolume()})};
k.ab=function(a){a={currentTime:a,videoBytesLoaded:this.b.getVideoBytesLoaded(),videoLoadedFraction:this.b.getVideoLoadedFraction(),currentTimeLastUpdated_:z()/1E3,playbackRate:this.b.getPlaybackRate(),mediaReferenceTime:this.b.getMediaReferenceTime()};this.b.getProgressState&&(a.progressState=this.b.getProgressState());Jh(this,a)};
k.cb=function(){if(this.b.getSphericalProperties){var a={sphericalProperties:this.b.getSphericalProperties()};Jh(this,a)}};
